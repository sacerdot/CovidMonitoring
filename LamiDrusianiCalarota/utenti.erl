...
utente()->
    ...
    Vis = spawn_link(fun() -> richiesta_luoghi([],Cont) end),
...
%ROOT ATTORE Vis
%richiesta_luoghi_ricorsiva([],Cont)->
%    process_flag(trap_exit, true),
%	receive
...
%Attore Luog
raggiungi3El(ListaAttuale,[]) ->ListaAttuale;
raggiungi3El(L=[_,_,_],_) -> L;
...
%        true -> 
        	L = aggiungiEl(ListaAttuale, ListaServerSenzaRip),
